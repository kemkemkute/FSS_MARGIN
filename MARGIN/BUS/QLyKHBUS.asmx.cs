...
namespace BUS
{
    ...
    public class QLyKHBUS : System.Web.Services.WebService
    {
        ...
        /// <returns></returns>
        [WebMethod]
        public int KTThongTinSuaKH(string soTKLK, DateTime ngayMoTK, string hoTen, DateTime ngaySinh, string noiCap, string soCMND, string diaChi, string hanMucVay, string SDT)
        {
            DateTime ngayDu18Tuoi = ngaySinh.AddYears(18);
            Check check = new Check();
            if (hoTen == "")
