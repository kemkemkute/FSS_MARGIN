            ...
            try
            {
                ...
                if(txtTimKiem.Text == "")
                {
                    foreach (QLyKHDTO temp in list)
                    {
                        ...
                        temp.gioiTinhKH, temp.diaChiKH, temp.ngayMoTKKH, temp.SDTKH);
                    }
                }
                else if(listCMND != null)
                {
                    gridTabKH.Rows.Add(listCMND.STKLK, listCMND.hoTenKH, listCMND.ngaySinhKH, 
                        ...
                        listCMND.gioiTinhKH,listCMND.diaChiKH,listCMND.ngayMoTKKH,listCMND.SDTKH);
                }
                else if(listTKLK != null)
                {
                    gridTabKH.Rows.Add(listTKLK.STKLK, listTKLK.hoTenKH, listTKLK.ngaySinhKH,
                        ...
                        listTKLK.gioiTinhKH, listTKLK.diaChiKH, listTKLK.ngayMoTKKH, listTKLK.SDTKH);
                }
                else
                {
